        ...
        <nav class="mt-2"><!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <!-- <li class="nav-item"><a href="#" class="nav-link"><i class="nav-icon bi bi-box-seam-fill"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"><a href="{{route('admin.anh_phong.index')}}" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                                <p>Danh sách</p>
                            </a></li>
                        <li class="nav-item"><a href="{{route('admin.anh_phong.create')}}" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                                <p>Tạo mới</p>
                            </a></li>
